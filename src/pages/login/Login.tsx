...
import { Container, Form, Input, InputGroup, InputGroupText, Modal, ModalHeader, ModalBody, ModalFooter, Button } from "reactstrap";
...
function Login() {
    ...
    return (
        <Container className="container-login justify-content-center">
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <InputGroup className="mt-5 w-100">
                    ...
                    <Input
                        ...
                        onChange={handleChange}
                    />
                    <InputGroupText onClick={() => setIsLoginPasswordVisible(!isLoginPasswordVisible)} style={{ cursor: 'pointer' }}>
            ...
            {/* Modal de bienvenida */}
            <Modal isOpen={showWelcomeModal} toggle={() => setShowWelcomeModal(!showWelcomeModal)}>
                ...
                <ModalFooter>
                    <Button color="primary" onClick={handleWelcomeModalNext}>Siguiente</Button>
                </ModalFooter>
            </Modal>

            {/* Modal para restablecer la contraseña */}
            <Modal isOpen={showPasswordResetModal} toggle={() => setShowPasswordResetModal(!showPasswordResetModal)}>
                <ModalHeader toggle={() => setShowPasswordResetModal(!showPasswordResetModal)}>
                    ...
                    <Form onSubmit={handlePasswordResetSubmit}>
                        <InputGroup className='w-100'>
                            ...
                            <Input
                                ...
                                required
                            />
                            <InputGroupText onClick={() => setIsResetPasswordVisible(!isResetPasswordVisible)} style={{ cursor: 'pointer' }}>
                                <FontAwesomeIcon icon={isResetPasswordVisible ? faEyeSlash : faEye} />
                            </InputGroupText>
                        </InputGroup>
                        <ModalFooter>
                            <Button color="primary" type="submit">Actualizar contraseña</Button>
                            <Button color="secondary" onClick={() => setShowPasswordResetModal(false)}>Cancelar</Button>
                        </ModalFooter>
                    </Form>
                </ModalBody>
            </Modal>
