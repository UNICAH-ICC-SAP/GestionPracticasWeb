...
import { Selector as fileSelector } from "@store/slices/documentManager"
import { useDispatch, useSelector } from "@store/index";
import UploadCard from "@components/shared/documentCard/uploadDocumentCard";
import { Fetcher as FetcherFiles } from "@store/slices/documentManager"
...
export default function Documentos() {
    ...
    return (
        <Container tag={'div'} fluid className='d-flex mt-2 flex-wrap gap-3 justify-content-center'>
            ...
            {selectedDoc && <UploadCard document={selectedDoc} user={user} userInfo={userInfo} onClick={() => {
                setShowCards(true);
                setSelectedDoc(null);
                setUpdateFiles(true);
            }} />}
